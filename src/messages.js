...
const messages = defineMessages({
  ...
  SlateEditorPlaceHolder: {
    id: 'Add item description...',
    defaultMessage: 'Add item description...',
  },
  ItemImage: {
    id: 'Item image',
  ...
  CardDefault: {
    id: 'Card (default)',
    defaultMessage: 'Card (default)',
  },
  ImageCard: {
    id: 'Image Card',
    defaultMessage: 'Image Card',
  },
  ImageOnLeft: {
    id: 'Image on left',
  ...
  ImageOnRightSide: {
    id: 'Image on Right (Default is Left)',
